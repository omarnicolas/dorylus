...
module.exports = {
	...
	hashSecret: "gX4DFOt9betptnEp3AqxH08P29es2At6jRTWH2QeR6K",

	// Secret for session hashing
	sessionSecret: "AVH3p5CjlUjqVngiqOJML4oZoxcbnhChUpW0dM4Y24x",
	...
	app: {
		...
		//contactEmail: "hello@dorylus.com"
	},
	...
	db: {
		// uri: process.env.MONGO_URI || "mongodb://localhost/dorylus",
		options: {
